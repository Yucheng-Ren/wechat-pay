# -*- coding: utf-8 -*-
#
# wechat-pay-sdk documentation build configuration file, created by
...
project = u'wechat-pay-sdk'
copyright = u'2017, Zack Ren'
author = u'Zack Ren'
...
latex_documents = [
    (master_doc, 'wechat-pay-sdk.tex', u'wechat-pay-sdk Documentation',
     u'Zack Ren', 'manual'),
]
